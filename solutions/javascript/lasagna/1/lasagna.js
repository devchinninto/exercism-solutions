 ...
 */
export function remainingMinutesInOven(x) {
  const remaining = EXPECTED_MINUTES_IN_OVEN - x
  return remaining
}
...
export function preparationTimeInMinutes(numberOfLayers) {
  const total = numberOfLayers * PREPARATION_MINUTES_PER_LAYER;
  return total
}
